...
for name, short in [('service-overview','overview'), ('weather-collection','collection'), ('mobile-weather-request','mobile'), ('kaq-image-pipeline','kaq')]:
...
# Product source remains identical to the baseline; the sole tracked edit is README navigation.
...
print(f'PASS: {count} local links; 4 evidence sources/specs/HTML/browser bindings; 36 showcase checks; original product files and README content preserved.')
