...
- The app builds `/weather/v000903/...` and `/geocode/v000903/...`. The 2026-09-20 AWS/deployed-source evidence verifies CloudFront -> API Gateway -> Lambda; weather coordinates dispatch to EC2 KMA address or DSF coordinates. Gateway code is outside this checkout. Recheck current evidence before relying on that deployment mapping; EC2 revision/mode remains unverified. Weather address Lambda is unsupported (501); unversioned weather defaults to v000901.
