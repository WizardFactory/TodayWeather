...
| Direct `/v000903/kma/addr/...` | CloudFront default behavior -> service EC2; source mounts KMA pipeline | Deployed Express revision unknown |
| Backend `/v000903/kma/coord/:loc` | Source resolves via `API_SERVER/geocode/coord/:loc`, then KMA | EC2 API_SERVER value unknown |
