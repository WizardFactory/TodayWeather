...
for name, short in [('service-overview','overview'), ('weather-collection','collection'), ('mobile-weather-request','mobile')]:
...
print(f'PASS: {count} local links; 3 evidence sources/specs/HTML/browser bindings; 27 showcase checks; original product files and README content preserved.')
