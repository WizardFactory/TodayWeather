...
gulp.task('build_ios', shell.task([
  ...
  'rm www/js/controller.purchase.js',
  'cp www/js/controller.purchase.alexdisler.js www/js/controller.purchase.js',
  'npm install',
  'cd node_modules/cordova-uglify/;npm install',
  'bower install',
  'gulp sass',
...
gulp.task('release-android-nonpaid', shell.task([
  ...
  'rm www/js/controller.purchase.js',
  'cp www/js/controller.purchase.j3k0.js www/js/controller.purchase.js',
  'npm install',
  'cd node_modules/cordova-uglify/;npm install',
  'bower install',
  'gulp sass',
