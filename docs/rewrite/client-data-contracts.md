...
| [World public-envelope example](examples/client-world-response.json) | [World normalized](examples/client-world-normalized.json) | ordered thisTime pair, `source:"DSF"` plus DSF publication discriminator, gateway-shaped geography |
